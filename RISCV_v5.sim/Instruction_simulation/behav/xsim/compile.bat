...
REM
REM Generated by Vivado on Wed Jan 19 17:14:56 -0500 2022
...
echo "xvlog --incr --relax -prj Rtype_tb_vlog.prj"
call xvlog  --incr --relax -prj Rtype_tb_vlog.prj -log xvlog.log
